...
test.serial('Agent#createOrUpdate - exists', async t => {
    ...
    t.true(_rec11._expr(_rec11._capt(_rec11._capt(_rec11._capt(AgentStub, 'arguments/0/object/object').update, 'arguments/0/object').calledOne, 'arguments/0'), {
        content: 't.true(AgentStub.update.calledOne, \'Update should be called once\')',
        filepath: 'tests/agent-tests.js',
        line: 86,
        async: true,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"update","range":[17,23]},"computed":false,"range":[7,23]},"property":{"type":"Identifier","name":"calledOne","range":[24,33]},"computed":false,"range":[7,33]},{"type":"StringLiteral","value":"Update should be called once","range":[35,65]}],"range":[0,66]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"update","range":[17,23]},{"type":{"label":"."},"range":[23,24]},{"type":{"label":"name"},"value":"calledOne","range":[24,33]},{"type":{"label":","},"range":[33,34]},{"type":{"label":"string"},"value":"Update should be called once","range":[35,65]},{"type":{"label":")"},"range":[65,66]}]',
        visitorKeys: _powerAssertVisitorKeys
    }), 'Update should be called once');
    t.deepEqual(agent, single, 'Agent should be the same');
});
//# sourceMappingURL=/home/m/Desktop/platzi/courses/node/avance/realTimeNodeJS/realTimeNodeJS-db/node_modules/.cache/ava/a02733a9f1bd1f8cf27c0c0134ef7dfa.js.map